...
export default function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full border border-white/10 bg-stone-900/90 px-4 py-3.5 font-semibold text-white shadow-lg shadow-black/40 backdrop-blur transition-transform hover:scale-105 hover:bg-stone-800"
    >
